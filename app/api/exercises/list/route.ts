...
function normalizeExercises(list: RemoteExercise[], tagId: string | number | null) {
  return list
...
export async function GET(request: Request) {
  ...
  const tagIdParam = search.get('tagId')
  const tagId = tagIdParam === '' || tagIdParam === null ? '' : tagIdParam
